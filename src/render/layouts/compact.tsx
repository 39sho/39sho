...
export function CompactLayout({ data, theme }: CompactLayoutProps) {
  return (
    <g>
      <rect x="24" y="24" width="852" height="1152" rx="28" fill={theme.panel} />
      <g transform="translate(50 46)">
        ...
        <HeatmapSection days={data.contributionHeatmap} x={0} y={340} width={800} title="Contributions (1 year)" theme={theme} />
